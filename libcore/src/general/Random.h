...
{
    assertm(_init, "RandomNumber not yet seeded!");
 ...
 * Between \p min and \p peak the probability is increasing linearly and from \p peak to \p max it is decreasing linearly.
...
/**
 * Returns a random number of a log-normal distribution with mean (\p mean) and standard deviation (\p stddev).
 * @tparam RealType
 * @param mean mean of the normal distribution
 * @param stddev standard deviation of the normal distribution
 * @return random number of a normal distribution with given parameters
